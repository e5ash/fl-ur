...
const _3af747 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _33be66, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _3af747, lazy: true, method: undefined },
  { route: '/**', handler: _3af747, lazy: true, method: undefined }
];
